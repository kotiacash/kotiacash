...
These are the dependencies currently used by kotia. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/kotianl
Keybase  - https://keybase.io/team/kotia/
