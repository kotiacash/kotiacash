...
const QString BITCOIN_IPC_PREFIX("kotia:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/kotia-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/kotia-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/kotia-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click kotia: links
...
//
// OSX-specific way of handling kotia: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in kotia: URIs
