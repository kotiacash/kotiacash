...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kotiacash/kotiacash>";
    const std::string URL_WEBSITE = "<https://kotia.cash/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The kotia Developers", 2021)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find kotia useful. "
