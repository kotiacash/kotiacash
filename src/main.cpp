...
#if defined(NDEBUG)
# error "kotia cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "kotia Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // kotia also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // kotia also requires low S in sigs
